...
namespace Korkusuz.PL.Controllers
{
    public class AdminCategoryController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,CreatedDate,IsDeleted")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,CreatedDate,IsDeleted")] Category category)
        {
            if (ModelState.IsValid)
            {
